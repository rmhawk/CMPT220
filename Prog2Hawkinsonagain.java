...
public class Prog2Hawkinsonagain
{
          ...
          //no arrays
     {
          ...
          {
               do//asks for input of the movie's length and verrifies
               {
                    System.out.println("Please enter the movie's length in minutes (between 1 and 240, inclusive): ");
                    movLength=keyboard.nextInt();
               }//do
               while (!((movLength>=1)&&(movLength<=240)));
               do//asks for input of the movie's rating and verifies
               {
               ...
               {
                    case 'G':
                         movCost=3.9*movLength;
                         break;
                    case 'P':
                         movCost=5.4*movLength;
                         break;
                    case 'R':
                         movCost=6.8*movLength;
                         break;   
                    case 'X':
                         movCost=27.3*movLength;
                         break;
                    case 'O':
                         movCost=4*movLength;
                         break;
               ...
               movTotal=movTotal+(movCost/100);//adds up each movie's cost
          }//for
