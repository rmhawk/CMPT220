...
public class Prog2Hawkinson
{
     public static void main (String args[])
     {
          ...
          {
               System.out.println("Please enter customer's name: ");//cannot have space right now
               custname=keyboard.next();
               //asks and takes input of customer's name
               
               do
               {
                    System.out.println("Please enter the customer's ID (between 25000 and 99999, inclusive), termate program by entering 0: ");
                    custid=keyboard.nextInt();
                    if (custid==0)
                         break;
               }//do
               while (!((custid>=25000)&&(custid<100000)));
          ...
          System.out.println("The total amount of all downloads purchased was "+moneystyle.format(total));//should this be the number of movies or the total cost?
